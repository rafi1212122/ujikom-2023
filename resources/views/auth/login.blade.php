...
<body>
    <section class="py-[7.69rem] bg-gradient-to-b from-sky-500 to-sky-300">
        <div class="w-4/5 flex items-center justify-center py-10 mx-auto rounded-2xl bg-white/50 gap-36">
                <img src="/img/logo-login-big-idn.svg" class="h-64 w-64" alt="">
            <div class="w-2/6 bg-white px-6 py-4 rounded-xl">
